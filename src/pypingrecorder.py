...
class pingrecorder:
    def __init__(self):
        self.ping_data = {
            website: {"timestamp": [], "value": [], "avg": [], "max": [], "jitter": [], "errors": [], "avg_histo": [], "max_histo": [], "jitter_histo": []}
            for website in ["google.com", "example.com", "openai.com"]
        }
        self.speed_data = {"timestamp": [], "download": [], "upload": [], "download_histo": [], "upload_histo": []}
            ...
            for website in self.ping_data:
                if self.ping_data[website]["timestamp"]:
                    oldest_timestamp = datetime.strptime(
                        self.ping_data[website]["timestamp"][0],
                        "%Y-%m-%d %H:%M:%S"
                    )
